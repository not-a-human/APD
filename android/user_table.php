<?php
	if(isset($_GET['m']) && isset($_GET['u'])){
		...
		$current_user = strtoupper($_GET['u']);
					...
					<tbody>
						...
						for($i = 0;$i < count($hari);$i++ ){
							...
							for ($col = 0; $col < 8; $col++) {
								...
								if($valid == "-"){
										echo "<td class='border p-0 align-middle'><a href='user_tempah?x=".($col+1)."&y=".$i."&w=".$thisweek."&m=".$minggu."&u=".$current_user."'>
